...
#######################################################################################################################
    ...
    async def cmd_아오짜집기도개짜증나네(self, message, channel, command=None):
        """
        Usage:
    ...
    async def cmd_노래등록(self, message, player, channel, author, permissions, leftover_args, song_url):
        """
        Usage:
    ...
    async def cmd_노래검색(self, message, player, channel, author, permissions, leftover_args):
        """
        Usage:
    ...
    async def cmd_현재노래정보(self, player, channel, guild, message):
        """
        Usage:
            {command_prefix}np
    ...
    async def cmd_들여보내기(self, channel, guild, author, voice_channel):
        """
        Usage:
    ...
    async def cmd_노래일시정지(self, player):
        """
        Usage:
    ...
    async def cmd_노래재개(self, player):
        """
        Usage:
    ...
    async def cmd_재생목록초기화(self, player, author):
        """
        Usage:
    ...
    async def cmd_노래제거(self, user_mentions, message, author, permissions, channel, player, index=None):
        """
        Usage:
    ...
    async def cmd_건너뛰기(self, player, channel, author, message, permissions, voice_channel, param=''):
        """
        Usage:
    ...
    async def cmd_소리조절(self, message, player, new_volume=None):
        """
        Usage:
    ...
    async def cmd_메세지청소(self, message, channel, guild, author, search_range=50):
        """
        Usage:
    ...
    @owner_only
    async def cmd_봇이름바꾸기(self, leftover_args, name):
        """
        Usage:
    ...
    async def cmd_봇닉네임바꾸기(self, guild, channel, leftover_args, nick):
        """
        Usage:
    ...
    async def cmd_봇재시작(self, channel):
        """
        Usage:
    ...
    async def cmd_봇끄기(self, channel):
        """
        Usage:
